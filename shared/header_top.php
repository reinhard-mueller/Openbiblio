	...
	<div class="headertop">
            <div class="headertop1">
                ...
                <?php
                 ...
                 ?>
                    <div style="clear:left;font-weight:normal;font-size:.85rem;margin-bottom:1rem">Interessengemeinschaft Ahnenforscher Ländle<br>Landesverein für Familienforschung in Vorarlberg</div> <!-- IGAL -->
                 </div>
            </div>
